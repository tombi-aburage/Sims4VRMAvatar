...
def male(in_vrm, in_sims4):
    VRoidModel = bpy.data.armatures[in_vrm]
    Sims4Model = bpy.data.armatures[in_sims4].edit_bones.data

    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_01'].head.x = Sims4Model.bones['b__R_UpperArm__'].head_local.x
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_01'].head.y = Sims4Model.bones['b__R_UpperArm__'].head_local.z * -1
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_01'].head.z = Sims4Model.bones['b__Neck__'].head_local.y
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_01'].length = 0.15
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_end_01'].head.z = Sims4Model.bones['b__Neck__'].head_local.y
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmOutside_end_01'].length = 0.15

    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_01'].head.x = Sims4Model.bones['b__L_UpperArm__'].head_local.x
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_01'].head.y = Sims4Model.bones['b__L_UpperArm__'].head_local.z * -1
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_01'].head.z = Sims4Model.bones['b__Neck__'].head_local.y
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_01'].length = 0.15
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_end_01'].head.z = Sims4Model.bones['b__Neck__'].head_local.y
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmOutside_end_01'].length = 0.15

    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_01'].head.x = Sims4Model.bones['b__R_UpperArm__'].head_local.x - 0.10
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_01'].head.y = Sims4Model.bones['b__R_UpperArm__'].head_local.z * -1
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_01'].head.z = Sims4Model.bones['b__Spine2__'].head_local.y
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_01'].length = 0.15
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_end_01'].head.z = Sims4Model.bones['b__Spine2__'].head_local.y
    VRoidModel.edit_bones['J_Sec_R_TopsUpperArmInside_end_01'].length = 0.15
    
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_01'].head.x = Sims4Model.bones['b__L_UpperArm__'].head_local.x + 0.10
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_01'].head.y = Sims4Model.bones['b__L_UpperArm__'].head_local.z * -1
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_01'].head.z = Sims4Model.bones['b__Spine2__'].head_local.y
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_01'].length = 0.15
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_end_01'].head.z = Sims4Model.bones['b__Spine2__'].head_local.y
    VRoidModel.edit_bones['J_Sec_L_TopsUpperArmInside_end_01'].length = 0.15
